...
function makeChargedPiAggregate(): PaymentIntentAggregate
{
    ...
    $cmd = new readonly class($piId) implements CreatePaymentIntentCommand
    {
        ...
        public function instrument(): PaymentInstrument { return new Token(TokenId::fromString('01961f5a-0000-7000-8000-000000000001'), new CreditCard(new Number('424242', '4242', CardBrand::Visa), Expiration::fromMonthAndYear(12, 2030), new Holder('Test'), new Cvc), ExpiresAt::fromDateTime(new DateTimeImmutable('+1 hour'))); }
